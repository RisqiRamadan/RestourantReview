package com.example.restourantreview.ui2;
...
import com.example.restourantreview.data.response.Restaurant;
...
import com.example.restourantreview.ui.ReviewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = APIConfig.getApiService().postReview(RESTAURANT_ID, "Risqi Ramadan", review);
